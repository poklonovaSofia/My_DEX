...
contract TokenExchange is Ownable {
        ...
        payable
    {
        ...
        require(eth_reserves - amountETH >= 1, "ETH reserves too low");
        require(token_reserves - tokensToReturn >= 1, "Token reserves too low");
        ...
        payable
    {
        ...
        require(amountTokens > 0, "Invalid token amount");
